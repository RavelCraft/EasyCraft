...
public class MiniBlockManager {
    ...
    public void playerChoseMiniBlcok(Player player, OnPlayerChooseMiniBlock callback) {
        ...
        for (MiniBlock block : miniBlocks) {
            ...
            group.addElement(new StaticGuiElement('e', item, click -> {
                ...
                callback.onPlayerChooseMiniBlock(player, inventoryGui, click);
    ...
    public interface OnPlayerChooseMiniBlock {
        void onPlayerChooseMiniBlock(Player player, InventoryGui gui, GuiElement.Click click);
    }
}
